...
func render(_ size: Int, _ name: String) throws {
    ...
    NSColor(calibratedRed: 0.063, green: 0.067, blue: 0.102, alpha: 1).setFill()
    NSBezierPath(roundedRect: NSRect(x: 45, y: 45, width: 934, height: 934), xRadius: 210, yRadius: 210).fill()
    NSColor(calibratedRed: 0.94, green: 0.95, blue: 0.92, alpha: 1).setStroke()
    ...
    NSColor(calibratedRed: 0.29, green: 0.871, blue: 0.502, alpha: 1).setFill()
