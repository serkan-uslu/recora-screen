...
const descriptions: Record<string, string> = {
  ...
  'timeline.apply': 'Apply sequential edits atomically. Times are OUTPUT milliseconds; normalized x/y/size are 0–1. Cut multiple ranges in reverse order to avoid shifting later ranges. Stale expectedRevision is rejected. One batch is one undo step.',
  ...
  'export.start': 'Render a project snapshot to a new external MP4 path. Never overwrite an existing file or source media. Returns Job.',
