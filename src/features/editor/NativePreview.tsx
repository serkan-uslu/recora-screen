...
import {
  usePreviewEditingController,
  type PreviewEditingProps,
} from "@/src/controllers/usePreviewEditingController";
import { useNativePreviewController } from "@/src/controllers/useNativePreviewController";
...
export function NativePreview(props: PreviewEditingProps & { hidden: boolean }) {
  ...
  const { desktop, ref, stageRef, aspect, previewWidth, ready } = useNativePreviewController({
    project,
    hidden,
    onError,
  });
